...
$(document).ready(function(){
    ...
    $(".thumb-wrap").on("dragleave",".thumb-img img",function(e){
        e.preventDefault();
        e.stopPropagation();
        if(!canvas.isAdd){
    ...
    $(".image-select").on("click","div",function(e){
        e.preventDefault();
        e.stopPropagation();
...
Canvas.prototype.bind_fn = function(){
    ...
    $("#canvas").on("drop",function(e){
        e.preventDefault();
        e.stopPropagation();
        $("#canvas .textNode").removeClass("event").removeClass("active");
    ...
    $("#canvas").on("mousemove",function(e){
        ...
        if($(e.target).closest(".textNode").length<=0 && _dragSrc != "" && moving){
    ...
    $("#canvas").on("mouseup",function(e){
        ...
        if(moving){
            ...
            if(curDom && _dragDom && curDom.attr("data-uid") != _dragDom.attr("data-uid")){
    ...
    $(document).on("drop mouseup",function(e){
        e.preventDefault();
        $("#canvas .textNode").removeClass("event");
        mouseX = 0;
        mouseY = 0;
        ...
        _dragSrc = "";
        _this.MOVE_SRC = "";
        if($(e.target).closest(".textNode").length<=0){
            _this.isAdd = false;
        }
    });
};
